...
export default function FeaturesSection() {
    return (
      <section id="features" className="w-full py-16 md:py-32 lg:py-40 bg-gray-100 dark:bg-gray-900 dark:text-white">
        <div className="container px-4 md:px-6">
          <div className="flex flex-col justify-center space-y-8 text-center">
            <div className="space-y-8 mx-auto max-w-[700px]">
              <div className="flex flex-col gap-3">
                <h1 className="text-center md:text-5xl text-4xl font-bold dark:text-white text-gray-900">Features</h1>
              ...
              <p className="text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                The all-in-one platform for creating, sharing, and tracking links. Shorten URLs, customize branded links,
                and measure engagement with advanced analytics.
              </p>
            </div>
            <div className="mx-auto grid max-w-sm items-start gap-6 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-4">
              <div className="grid gap-2 bg-white h-full px-4 py-6 rounded-lg shadow-lg">
                <LinkIcon className="w-10 h-10 mx-auto text-blue-500" />
                <h3 className="text-lg font-bold">Custom short links</h3>
              ...
              <div className="grid gap-2 bg-white h-full px-4 py-6 rounded-lg shadow-lg">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Secure your links with password protection for restricted access.
                </p>
              </div>
              <div className="grid gap-2 bg-white h-full px-4 py-6 rounded-lg shadow-lg">
                <CalendarCheckIcon className="w-10 h-10 mx-auto text-blue-500" />
                <h3 className="text-lg font-bold">Expiry dates</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">
